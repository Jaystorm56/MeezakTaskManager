  ...
  return (
    <div  className='relative'>
      ...
      <div className='absolute top-[209px] left-[480px] w-[480px] h-[480px]'>
          ...
          <h2 className='text-[#333333] w-[245px] h-[30px] text-[24px] font-bold uppercase leading-[100%] tracking-[0] m-auto'>Admin's Login
          </h2>

          <form  onSubmit={handleAdminLogin} className='w-full h-fit'>
            ...
            <Link to="/adminsignup" className="block w-fit h-[18px] mx-auto font-normal text-[14px] leading-[100%] tracking-[0%] text-[#333333]">
